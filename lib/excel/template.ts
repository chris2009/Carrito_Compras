...
export function generateTemplate(): Uint8Array<ArrayBuffer> {
  ...
  const instrucciones = [
    ...
    ['imagen_url', 'URL de la imagen principal (debe comenzar con https://) — OPCIONAL, se puede agregar después'],
    ['imagen_url_2', 'URL de imagen secundaria — OPCIONAL'],
    ['imagen_url_3', 'URL de tercera imagen — OPCIONAL'],
    ...
    [''],
    ['SOBRE LAS IMÁGENES (importante leer)'],
    ['', '¿No tienes la URL de la imagen? ¡No hay problema!'],
    ['', 'Deja las columnas imagen_url vacías al importar.'],
    ['', 'Luego ve a Dashboard → Productos → edita cada producto'],
    ['', 'y sube la foto directamente desde tu computadora.'],
    ['', ''],
    ['', 'Las URLs solo son necesarias si ya tienes las imágenes'],
    ['', 'publicadas en internet (ej: en otra tienda o sitio web).'],
    [''],
    ['NOTAS IMPORTANTES'],
